...
videoWriter = cv2.VideoWriter("C:/Users/user/Desktop/五條魚_test/counting.mp4", fourcc, fps, size)
...
#得到目标矩形框的左上角和右下角坐标
    ...
    #得到要书写的文本的宽和长,用于给文本绘制背景色
        ...
        #书写文本
        cv2.putText(image,
        label, (p1[0], p1[1] - 2 if outside else p1[1] + h + 2),0,2 / 3,txt_color,thickness=1,lineType=cv2. LINE_AA)

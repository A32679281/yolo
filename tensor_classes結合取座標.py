...
#url="https://www.youtube.com/watch?v=jIRRuGN0j5E"
#model = torch.hub.load('ultralytics/yolov5', 'yolov5x')
model = YOLO("yolov8x.pt")
#cap = cap_from_youtube(url,'1080p60')
cap = cv2.VideoCapture("C:/Users/user/Desktop/無人機影片/100MEDIA/學長姐/DJI_0002.MOV") #input("請輸入網址：") #YT進不來  #"https://cctv.bote.gov.taipei:8501/mjpeg/068" #C:/Users/user/Desktop/無人機影片/100MEDIA/3.30/DJI_0008.MOV
...
while True:
    ...
    if not success:
        ...
        break
    #frame = cv2.resize(frame, (1240, 810))             若調整resize在imshow的時候方便看，但無法輸出影片
    ...
    cv2.putText(frame, f'FPS: {int(1 / (time.time() - prev_time))}',(500, 40), cv2.FONT_HERSHEY_PLAIN, 3, (0, 0, 255), 3)
